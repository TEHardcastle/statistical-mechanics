...
function updateCentreOfMass(pointAXValue, pointBXValue, pointAYValue, pointBYValue){
    let centreOfMassX = (parseFloat(pointBXValue) + parseFloat(pointAXValue)) / 2;
    let centreOfMassY = (parseFloat(pointBYValue) + parseFloat(pointAYValue)) / 2;
    ...
    document.getElementById("centreOfMass").setAttribute("cx", centreOfMassX);
    document.getElementById("centreOfMass").setAttribute("cy", centreOfMassY);
    document.getElementById("comXValue").innerHTML = convertX(centreOfMassX).toPrecision(4);
...
function resetPoints(){
    ...
    document.getElementById("centreOfMass").setAttribute("cx", 152);
    document.getElementById("centreOfMass").setAttribute("cy", 348);
    document.getElementById("comXValue").innerHTML = "30.00";
    document.getElementById("comYValue").innerHTML = "30.00";
